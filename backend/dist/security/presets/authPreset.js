...
exports.createAuthPreset = createAuthPreset;
...
function createAuthPreset(config = {}) {
    ...
    pipeline
        ...
        .add(new LengthSanitizer_1.LengthSanitizer({ maxLength: 100, debug: config.debug, strict: true }))
        ...
        .add(new XSSSanitizer_1.XSSSanitizer({ debug: config.debug, strict: true }))
...
//# sourceMappingURL=authPreset.js.map