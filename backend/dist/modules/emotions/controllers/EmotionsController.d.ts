...
export declare class EmotionsController {
    ...
    getEmotionsForNode: (req: Request, res: Response, next: NextFunction) => Promise<void>;
    replaceEmotionsForNode: (req: Request, res: Response, next: NextFunction) => Promise<void>;
    removeEmotionsFromNode: (req: Request, res: Response, next: NextFunction) => Promise<void>;
