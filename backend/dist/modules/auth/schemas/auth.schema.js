...
exports.recoverSchema = exports.updatePasswordSchema = exports.loginSchema = exports.registerSchema = void 0;
...
exports.recoverSchema = zod_1.z.object({
    body: zod_1.z.object({
        login: zod_1.z.string().min(1, 'Login is required'),
        backup_code: zod_1.z.string().min(1, 'Backup code is required'),
