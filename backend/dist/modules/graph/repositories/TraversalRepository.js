...
exports.TraversalRepository = void 0;
const BaseRepository_1 = require("../../../shared/repositories/BaseRepository");
class TraversalRepository extends BaseRepository_1.BaseRepository {
    constructor(pool) {
        super(pool);
    }
    async traverse(startNodeId, userId, options = {}) {
    ...
    async getNeighbors(nodeId, userId) {
        const result = await this.pool.query(`SELECT DISTINCT
      ...
      ORDER BY link_count DESC`, [nodeId, userId]);
        return result.rows;
    }
}
exports.TraversalRepository = TraversalRepository;
//# sourceMappingURL=TraversalRepository.js.map