...
describe('Thoughts Module', () => {
  ...
  describe('GET /api/v1/thoughts', () => {
    it('should list all thoughts', async () => {
      await TestFactories.createThought(testUser.id, { title: 'Thought 1' });
      await TestFactories.createThought(testUser.id, { title: 'Thought 2' });
  ...
  describe('GET /api/v1/thoughts/:id', () => {
    ...
    beforeEach(async () => {
      thought = await TestFactories.createThought(testUser.id, { content: 'A thought' });
    });
  ...
  describe('PATCH /api/v1/thoughts/:id', () => {
    ...
    beforeEach(async () => {
      thought = await TestFactories.createThought(testUser.id);
    });
  ...
  describe('Cross-user isolation', () => {
    ...
    beforeEach(async () => {
      ...
      userBToken = TestHelpers.createToken(userB.id, userB.login);
      userAThought = await TestFactories.createThought(testUser.id, {
    ...
    it('should return 404 when user B GETs user A thought', async () => {
      const response = await request(app)
        ...
        .set('Authorization', TestHelpers.authHeader(userBToken))
        .expect(404);
  ...
  describe('Query params', () => {
    it('should filter by from date', async () => {
      await TestFactories.createThought(testUser.id, { title: 'Old thought' });
    ...
    it('should filter by to date', async () => {
      await TestFactories.createThought(testUser.id, { title: 'New thought' });
